        ...
        <Box>
            ...
            <OrderedList spacing={6}>
                <ListItem>
                    ...
                    <Image src="images/burn-images-to-sd-01.webp" alt="Download Fedora image" mt={2} borderRadius="md" />
                </ListItem>
                ...
                <ListItem>
                    ...
                    <Image src="images/burn-images-to-sd-02.webp" alt="Download balenaEtcher" mt={2} borderRadius="md" />
                </ListItem>
                
                <ListItem>
                    Open balenaEtcher, click "Flash from file", and select the image you just downloaded.
                    <Image src="images/burn-images-to-sd-03.webp" alt="Open balenaEtcher" mt={2} borderRadius="md" />
                    <Image src="images/burn-images-to-sd-04.webp" alt="Select image file" mt={2} borderRadius="md" />
                </ListItem>
                
                <ListItem>
                    Insert your SD card into your computer and click "Select target".
                    <Image src="images/burn-images-to-sd-05.webp" alt="Select target 1" mt={2} borderRadius="md" />
                    <Image src="images/burn-images-to-sd-06.webp" alt="Select target 2" mt={2} borderRadius="md" />
                </ListItem>
                
                <ListItem>
                    Click "Flash". Once completed, the SD card will be ready for booting.
                    <Image src="images/burn-images-to-sd-07.webp" alt="Flash SD card" mt={2} borderRadius="md" />
                </ListItem>
            </OrderedList>
        </Box>
    );
